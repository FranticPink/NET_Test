<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="BookShop.Web.Manage.Main" %>
                                    ...
                                    <asp:GridView id="gvOrderList" runat="server" SkinID ="gvSkin"  OnPageIndexChanging="gvOrderList_PageIndexChanging" AllowPaging="True" AutoGenerateColumns="False" >
                                        <Columns>
                                            <asp:TemplateField HeaderText="单号">
                                                ...
                                                <ItemTemplate >
                                                 <a href='OrderModify.aspx?OrderID=<%# DataBinder.Eval(Container.DataItem, "orderNo") %>'>
														<%# DataBinder.Eval(Container.DataItem, "orderNo") %>
												</a>
                                                    <asp:LinkButton ID="orderNo" runat="server" 
                                                        Text='<%# DataBinder.Eval(Container.DataItem, "orderNo") %>' 
                                                        onclick="orderNo_Click"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:BoundField DataField="orderMoney" HeaderText="订单总金额"  >
                                                <ItemStyle HorizontalAlign="Center" />
                                                <HeaderStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
