<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Left.aspx.cs" Inherits="BookShop.Web.Manage.Left" %>
				...
				<td>
					<div class="sec_menu" id="menu5" style="WIDTH: 176px; height: 35px; background-color: #ffcc00;">
						<table cellSpacing="0" cellPadding="0" width="140" align="center">
							...
							<tr>
								<td style="height: 20px"><A href="LeaveWordManage.aspx" target="right">留言管理</A></td>
							</tr>
						</table>
					</div>
				</td>
			...
			<tr>
				<td>
					<div class="sec_menu" id="menu6" style="WIDTH: 172px; background-color: #ffcc00;">
						<table cellSpacing="0" cellPadding="0" width="140" align="center">
							<tr>
								<td height="20" style="width: 141px">&nbsp;官方网站：ST<a href="http://www.mrbccd.com" target="_blank">科技软件</a></td>
							</tr>
							<tr>
