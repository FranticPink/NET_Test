<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Top.aspx.cs" Inherits="BookShop.Web.Manage.Top" %>
...
function switchBar(obj)
{
	if (displayBar)
	{
		parent.frame.cols="0,*";
		displayBar=false;
		obj.src="../Images/admin_top_open.jpg";
		obj.title="打开左边管理菜单";
	}else{
		parent.frame.cols="180,*";
		displayBar=true;
		obj.src="../Images/admin_top_close.jpg";
		obj.title="关闭左边管理菜单";
	}
}
-->
...
<tr valign="middle">
	<td width="50">
	<img onclick="switchBar(this)" src="../Images/admin_top_close.jpg" alt="关闭左边管理菜单" style="cursor:hand" />
	</td>
</tr>
</table>
</body>
