<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderModify.aspx.cs" Inherits="BookShop.Web.Manage.OrderModify" %>
    ...
    <TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff" border="0">
				<TBODY>
					<TR>
						...
						<TD class="body-shoptitle" vAlign="middle" align="center" width="67%">订单号码：<%=MOrderSh.orderNo%><br>
							下单日期：<%=MOrderSh.orderDate%>
						</TD>
					</TR>
				</TBODY>
			</TABLE>
			...
			<TABLE id="Table4" cellSpacing="3" cellPadding="3" width="100%" bgColor="#ffffff" border="0">
				<TBODY>
					...
					<asp:repeater id="rptOrderItems" Runat="server">
						<ItemTemplate>
							<TR>
								<TD align="left" width="64" height="20"><%# DataBinder.Eval(Container.DataItem, "ISBN")%></TD>
								<TD align="left" width="64" height="20"><%# DataBinder.Eval(Container.DataItem, "bookTitle")%></TD>
								<TD align="left" width="99" height="20"><%#DataBinder.Eval(Container.DataItem, "Num")%></TD>
								<TD align="left" width="98" height="20"><%# GetHotPrice(DataBinder.Eval(Container.DataItem, "price").ToString())%>￥</TD>
								<TD align="left" width="104" height="20"><%# GetTotailPrice(DataBinder.Eval(Container.DataItem, "totalPrice").ToString())%>￥</TD>
								<TD width="80"align="center"><%# DataBinder.Eval(Container.DataItem, "bookState")%></TD>
							</TR>
						</ItemTemplate>
					</asp:repeater>
					<TR>
						...
						<table id="Table6" width="100%">
							<tr>
								<td style="BORDER-RIGHT: #000000 1px solid; BORDER-TOP: #000000 1px solid; BORDER-LEFT: #000000 1px solid; BORDER-BOTTOM: #000000 1px solid"
									...
									<td width="5%"></td>
									<td><%=GetStatus((MOrderSh.orderNo).ToString())%></td>
							</tr>
							<tr>
								<td style="BORDER-RIGHT: #000000 1px solid; BORDER-TOP: #000000 1px solid; BORDER-LEFT: #000000 1px solid; BORDER-BOTTOM: #000000 1px solid"
									align="left" width="30%">配送方式：</td>
									<td width="5%"></td>
									<td><%=MOrderSh.shipTel%></td>
							</tr>
						</table>
					</td>
					<td width="50%">
						<table id="Table7" width="100%">
							<tr>
								...
								<td width="5%"></td>
								<td><%=string.Format("{0:f}", MOrderSh.orderMoney)%>￥ </td>
							</tr>
