<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Member.aspx.cs" Inherits="BookShop.Web.Manage.Member" %>
				...
				<tr>
					<td style="height: 23px;font-family :宋体; font-size :9pt;">
                        &nbsp;<asp:GridView ID="gvAdminList" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:BoundField DataField="employeeNo" HeaderText="代号" ReadOnly="True" >
                                ...
                                <asp:BoundField DataField="empPassword" HeaderText="密码" >
                                    <ItemStyle HorizontalAlign="Center" />
                                    <HeaderStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="empName" HeaderText="真实名" >
                                    <ItemStyle HorizontalAlign="Center" />
                                    <HeaderStyle HorizontalAlign="Center" />
                                </asp:BoundField>
