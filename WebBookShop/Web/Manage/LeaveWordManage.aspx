<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaveWordManage.aspx.cs" Inherits="BookShop.Web.Manage.LeaveWordManage" %>
        ...
        <tr>
            <td colspan="3" style="width: 550px;">
                <table cellpadding="0" cellspacing="0" style="width: 100%">
                    ...
                    <tr>
                        <td colspan="3" style="width: 739px; text-align: center;">
                            ...
                            留言主题</span></td>
                                            <td style="width: 382px; text-align: left">
                                           无
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                留 言 人</td>
                                            <td style="width: 382px; text-align: left">
                                            <%#DataBinder.Eval(Container,"DataItem.memberNo") %>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                            ...
                            留言时间</span></td>
                                        ...
                                        <tr>
                                            <td>
                                                <span style="font-size: 9pt">
                            留言内容</span></td>
                                            <td rowspan="2" style="width: 382px; text-align: left">
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size: 9pt; width: 382px; text-align: right">
                                                <a href='LeaveWordBack.aspx?ID=<%#DataBinder.Eval(Container,"DataItem.messageNo") %>' style="color: #0000ff;
                                                    text-decoration: none"><span style="color: #000000">回复留言</span></a> <a href='ShowWord.aspx?ID=<%#DataBinder.Eval(Container,"DataItem.messageNo") %>'
                                                        style="font-size: 9pt; color: #0000ff; text-decoration: none"><span style="color: #000000">
                                                            查看回复</span></a> <asp:LinkButton ID="lnkbtnDelete" runat="server" CommandName="delete" CommandArgument =<%#DataBinder.Eval(Container,"DataItem.messageNo") %>
