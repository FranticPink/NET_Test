<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderList.aspx.cs" Inherits="BookShop.Web.Manage.OrderList" %>
				...
				<tr>
					<td style="height: 23px;font-size :9pt;">
                        ...
                        <asp:TemplateField  HeaderText ="跟单员">
									...
									<ItemTemplate>
										<%#GetAdminName(DataBinder.Eval(Container.DataItem, "orderNo").ToString()) %>
									</ItemTemplate>                                
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField  HeaderText ="下订时间">
                         ...
                         <asp:TemplateField HeaderText="货品总额">
                                   <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
									<ItemStyle HorizontalAlign="Left" ></ItemStyle>
									<ItemTemplate>
										<%#GetVarGF(DataBinder.Eval(Container.DataItem, "orderMoney").ToString()) %>
									</ItemTemplate>                              
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="运费">
                                  <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
									...
									<ItemTemplate>
										<%# GetVarSF(DataBinder.Eval(Container.DataItem, "orderMoney").ToString())%>
									</ItemTemplate>                             
                        </asp:TemplateField>
                          <asp:TemplateField HeaderText="总金额">
                                  <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center" ></ItemStyle>
									<ItemTemplate>
										<%# GetVarTP(DataBinder.Eval(Container.DataItem, "orderMoney").ToString())%>
									</ItemTemplate>                         
                        </asp:TemplateField>
                            <asp:BoundField DataField="payWay" HeaderText="配送方式">
                         ...
                         <asp:BoundField DataField="receiver" HeaderText="联系电话">
                                <ItemStyle HorizontalAlign="Center" />
                                <HeaderStyle HorizontalAlign="Center" />
                        </asp:BoundField>   
                        ...
                        <asp:TemplateField HeaderText="订单状态">
                              <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center" ></ItemStyle>
									<ItemTemplate>
										<%# GetStatus((DataBinder.Eval(Container.DataItem, "orderNo").ToString()))%>
									</ItemTemplate>                
                        </asp:TemplateField >
                        <asp:TemplateField HeaderText="管理">
                             <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center" ></ItemStyle>
									<ItemTemplate>
										<a href='OrderModify.aspx?OrderID=<%# (DataBinder.Eval(Container, "DataItem.orderNo").ToString()) %>'>
											管理</a>
									</ItemTemplate>            
                        </asp:TemplateField>
