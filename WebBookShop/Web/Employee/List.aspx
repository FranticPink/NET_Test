<%@ Page Title="Employee" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="BookShop.Web.Employee.List" %>
...
<!--Title -->
            ...
            <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3"  OnPageIndexChanging ="gridView_PageIndexChanging"
                    BorderWidth="1px" DataKeyNames="employeeNo" OnRowDataBound="gridView_RowDataBound"
		...
		<asp:BoundField DataField="empPassword" HeaderText="empPassword" SortExpression="empPassword" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="salary" HeaderText="salary" SortExpression="salary" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="email" HeaderText="email" SortExpression="email" ItemStyle-HorizontalAlign="Center"  /> 
                            ...
                            <asp:HyperLinkField HeaderText="详细" ControlStyle-Width="50" DataNavigateUrlFields="employeeNo" DataNavigateUrlFormatString="Show.aspx?id={0}"
                                Text="详细"  />
                            <asp:HyperLinkField HeaderText="编辑" ControlStyle-Width="50" DataNavigateUrlFields="employeeNo" DataNavigateUrlFormatString="Modify.aspx?id={0}"
                                Text="编辑"  />
