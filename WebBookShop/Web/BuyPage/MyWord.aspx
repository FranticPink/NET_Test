<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="MyWord.aspx.cs" Inherits="BookShop.Web.BuyPage.MyWord" %>
...
<table style=" font-size: 9pt; font-family: 宋体; width:574px; height :806px; background-repeat :no-repeat; background-image: url(images/显示页面当前位置.jpg);">
        ...
        <tr>
            <td colspan="3" style="width: 550px; vertical-align: top; text-align: center;">
                            ...
                            留言内容</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="font-size: 9pt; width: 382px; text-align: right">
                                               ...
                                               <a href='leaveWordView.aspx?ID=<%#DataBinder.Eval(Container,"DataItem.messageNo") %>'
