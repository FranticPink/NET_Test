<%@ Page Title="" Language="C#"  MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="showInfo.aspx.cs" Inherits="BookShop.Web.BuyPage.showInfo" %>
...
<table  cellSpacing="1" cellPadding="1" width="480" align="center" border="0" id="tabAddProduct">
				<tr>
					<td  align="left" height="25" colspan="2" style ="font-family :宋体; font-size :9pt;">
						&nbsp;&nbsp;
						<asp:label id="labTitleInfo" Runat="server">图书详细信息</asp:label>
					</td>
				</tr>
				<tr>
					<td style="width: 478px">
						<table  cellSpacing="0" cellPadding="0" width="95%" align="center" border="0">
							...
							<tr>
								<td align="left" style ="font-family :宋体; font-size :9pt;">销售价：
								</td>
								<td colSpan="3" align="left"><asp:textbox id="txtHotPrice" runat="server">0</asp:textbox></td>
							</tr>
                            							<tr>
								<td align="left" style ="font-family :宋体; font-size :9pt;">目录：
								</td>
								<td colSpan="3" align="left"><asp:textbox id="catalog" runat="server" Width="307px" Height="89px" TextMode="MultiLine">0</asp:textbox></td>
							</tr>
							<tr>
								<td align="left" style="font-family :宋体; font-size :9pt;height: 22px">
                                    图像：
