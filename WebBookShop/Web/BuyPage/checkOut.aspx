<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="checkOut.aspx.cs" Inherits="BookShop.Web.BuyPage.checkOut" %>
						...
						<tr style =" font :9pt; font-family :宋体;">
							...
							<tr style =" font :9pt; font-family :宋体;">
								<td align="center" colSpan="4"><br>
									<asp:button id="btnConfirm" runat="server" Text="提交订单" 
                                        OnClick="btnConfirm_Click" style="height: 21px"  ></asp:button>
                                    </td>
							</tr>
						</table>
					</td>
